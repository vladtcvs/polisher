...
// Parameters
static int TABLE_PERIOD = 43;  // Period of table rotation in seconds
static int MIRROR_PERIOD = 55; // Period of mirror rotation in seconds
static int X_SPEED = 30;       // Speed of X movement, mm/seconds
static float X_AMPL_1 = 15.0;  // Amplitude of X movements in mm
static float X_AMPL_2 = 15.0;  // Amplitude of X movements in mm
...
void core_calculate_parameters(void)
{
    ...
    table_delay_us = 1e6 * TABLE_PERIOD / table_steps_per_rot;
    table_timer = 0;
    ...
    mirror_delay_us = 1e6 * MIRROR_PERIOD / mirror_steps_per_rot;
    mirror_timer = 0;
